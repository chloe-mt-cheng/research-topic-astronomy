...
cd run_files_${a}_${e}
cp /geir_data/scr/ccheng/AST425/Personal/occam_clusters_input.py /geir_data/scr/ccheng/AST425/Personal/run_files_${a}_${e}/occam_clusters_input.py
...
cp /geir_data/scr/ccheng/AST425/Personal/ABC.py /geir_data/scr/ccheng/AST425/Personal/run_files_${a}_${e}/ABC.py
cp /geir_data/scr/ccheng/AST425/Personal/run_code.py /geir_data/scr/ccheng/AST425/Personal/run_files_${a}_${e}/run_code.py
