"""Usage: run_code.py [-h][--cluster=<arg>][--scale_factor=<arg>][--num_sigma=<arg>]
...
def run_everything(cluster, num_sigma, scale_factor=None):
	...
	apogee_cluster_data, spectra, spectra_errs, T, num_elem, num_stars, bitmask = ABC.get_cluster_data(cluster, scale_factor)
	#Fit the data
	...
	#path = '/Users/chloecheng/Personal/' + name_string + '/' + name_string + '_' + timestr + '.hdf5' #Personal path
	path = '/geir_data/scr/ccheng/AST425/Personal/' + name_string + '/' + name_string + '_' + timestr + '.hdf5' #Server path
...
if __name__ == '__main__':
	...
	D_cov_all, ks_all = run_everything(arguments['--cluster'], arguments['--num_sigma'], arguments['--scale_factor'])